    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Members__206D9170026C53EE", x => x.User_Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__BookPlan__9BAF9B0351C75CDE", x => x.Plan_Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Notice__E9930CABBB2E44A7", x => x.Notice_Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Book__C223F3B45E6536D8", x => x.Book_Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Learn__31999300BF643019", x => x.Learn_Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__PlanMemb__09D768C031119E03", x => new { x.User_Id, x.Plan_Id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Post__5875F7AD2DEF8D8D", x => x.Post_Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Statisti__A2EC2FD9F1F7BAB4", x => x.Statistics_Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Progress__D558797A78B1BA0E", x => x.Progress_Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Topic__8DEAA4050CB88B32", x => x.Topic_Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Post_Rep__AF4E25E3B72A40DD", x => x.P_Report_Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Reply__B66332845B1014D1", x => x.Reply_Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Reply_Re__6B66990FC2260C00", x => x.R_Report_Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Members__A9D10534F7B3454D",
                table: "Members",
                column: "Email",
                unique: true);
