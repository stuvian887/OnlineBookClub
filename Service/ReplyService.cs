...
public class ReplyService 
{
    ...
    public async Task<ReplyDTO?> GetReplyByIdAsync(string email, int ReplyID, HttpRequest request)
    {
        ...
        return new ReplyDTO
        {
            ...
            ImgPath = string.IsNullOrEmpty(Reply.ReplyImg) ? null : $"{hostUrl}{Reply.ReplyImg}",
